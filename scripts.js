class Stepper {
    ...
    storeData(stepNum) {
        ...
        if (stepNum === 2) {
            ...
            if (handler instanceof Step2Handler && handler.userLevel === 3) {
                handler.updateSingleLevel3Rep();
            }
        }
        if (stepNum === 3) {
            const fiscalDate = document.querySelector("#s3q2-field")?.value;
            const windupField = document.querySelector("#s3q3-field");
            const sameAsCheckbox = document.querySelector("#s3q3-op1");
